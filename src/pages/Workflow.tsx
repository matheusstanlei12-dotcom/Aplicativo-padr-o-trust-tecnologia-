...
export const WorkflowPage: React.FC = () => {
    ...
    const filtered = peritagens.filter(p => {
        const clientVal = p.cliente ? p.cliente.toLowerCase() : '';
        const osVal = p.os_interna ? p.os_interna.toLowerCase() : '';
        const term = searchTerm.toLowerCase();

        const matchesSearch = clientVal.includes(term) || osVal.includes(term);
